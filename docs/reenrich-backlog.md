...
| Person | School | Class |
|---|---|---|
| Iris Lindgren | University of Texas | 2 |
| Vesper Han | University of Texas | 2 |
...
| Person | Claims | Note |
|---|---|---|
| Mateo Ibarra | 0 | known namesake/identity-broker issue (see identity hardening notes) |
| Owen Thackeray | 0 | |
| Peter Hallam | 0 | common name — likely identity-gated out |
| Ishani Bose | 0 | |
