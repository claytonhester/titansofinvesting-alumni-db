...
<html><body>
  <div class="sqs-html-content" data-sqsp-text-block-content>
    ...
    <p>Beckett Rowan, Teacher Retirement System of Texas, Austin</p>
    <p>&nbsp;</p>
    <p>Jonah Kessler, Veritas Ark Fund, Texas Precious Metals, Austin</p>
...
def test_simple_entry_fields(records):
    cason = records[0]
    assert cason.full_name == "Beckett Rowan"
...
def test_company_with_internal_commas(records):
    kaspar = records[1]
    assert kaspar.full_name == "Jonah Kessler"
...
<html><body>
  <div class="sqs-html-content">
    ...
    <p>Arjun Sundaresan, Acme Capital, Austin</p>
    <p><strong>University of Texas Titans 15</strong></p>
    <p>Arjun Sundaresan, Other Fund, Austin</p>
    <p>Camden Whitlock Whitlock, Caterpillar, Houston</p>
  </div>
</body></html>
"""
...
def test_same_name_gets_deterministic_unique_slugs():
    ...
    devans = [r for r in recs if r.full_name == "Arjun Sundaresan"]
    assert len(devans) == 2
