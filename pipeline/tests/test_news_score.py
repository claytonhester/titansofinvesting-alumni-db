...
class TestEmployerComention:
    def test_significant_token_present(self):
        assert employer_comention("Kessler Companies expands", "Kessler Companies") is True
...
class TestScoreMention:
    def test_name_and_employer_cooccur_is_confident(self):
        s = score_mention(
            name="Jonah Kessler", employer="Kessler Companies",
            title="Jonah Kessler named CEO of Kessler Companies",
    ...
    def test_company_page_without_person_name_not_confident(self):
        ...
        s = score_mention(
            name="Caleb Norquist", employer="Brightstar Capital Partners",
    ...
    def test_aggregator_domain_never_confident(self):
        ...
        s = score_mention(
            name="Caleb Norquist", employer="Brightstar Capital Partners",
            title="Caleb Norquist - Brightstar Capital Partners",
            snippet="Caleb Norquist at Brightstar Capital Partners",
            domain="idcrawl.com",
        )
