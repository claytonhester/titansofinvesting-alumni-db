...
blurb (the "Trent Aldana named to Forty Under Forty" bug — actually Chris Halaska's
...
def name_mention_count(text: str, name: str) -> int:
    ...
    name-dropped inside someone else's story — the Trent Aldana / Forty-Under-Forty
