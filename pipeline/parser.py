...
def _dedupe_trailing_word(name: str) -> str:
    """Collapse an immediately-repeated trailing word: 'Camden Whitlock
    Whitlock' -> 'Camden Whitlock'. This is a recurring typo in the public
...
def _assign_unique_slugs(records: list[PersonRecord]) -> list[PersonRecord]:
    ...
    Two alumni can share a name (e.g. two 'Arjun Sundaresan's in different cohorts).
