...
- **Never cross-merges the current role** — a current_title folded into a
  ...
  restoring the input claims verbatim (the Nora Whitfield case, person 672).
...
def _tiebreak_career(
    ...
    how refreshed LinkedIn dates got lost behind stale web text (the Grant Larkin
...
def _restore_cross_type_current_drops(
    ...
    Observed live (person 672, Nora Whitfield, 2026-06-11): the model folded the
