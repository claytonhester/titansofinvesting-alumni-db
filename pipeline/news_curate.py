...
# someone else's story — the Trent Aldana / Forty-Under-Forty case, where Ross is
...
# page ("Trent Aldana, CFA") without making it an article.
...
def _is_name_only_title(title: str, name: str) -> bool:
    ...
    bio / profile / team-page heading, never an article — e.g. 'Trent Aldana, CFA'
...
# page that names the person inside someone ELSE's entry ("Trent Aldana named to
