...
const SAMPLE_NEWS: NewsItem[] = [
  {
    ...
    personName: "Jonah Kessler",
    school: "Texas A&M",
    titanClass: 0,
    category: "Market Views",
    headline:
      "Veritas Ark's Kessler Makes the Case for Hard Assets in Every Allocation",
    snippet:
